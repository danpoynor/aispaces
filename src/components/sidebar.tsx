...
export default function Sidebar() {
  ...
  return (
    <div className="space-y-4 py-4 flex flex-col h-full bg-[#051937] text-white" style={{ backgroundImage: "linear-gradient(to right bottom, #051937, #051937, #004d7a, #008793, #00bf72, #a8eb12)" }}>
      <div className="px-3 py-2 flex-1">
        <Link href="/dashboard" className="flex items-center justify-start w-full pl-4 mb-10">
          ...
          <h1 className={cn("text-xl font-bold", montserrat.className)}>AiSpaces.com</h1>
        </Link>
